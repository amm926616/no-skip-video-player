from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QInputDialog, QMessageBox, QFileDialog, QGraphicsView, QGraphicsScene
...
class VideoPlayer(QWidget):
    def __init__(self):
        ...
        # Connect mediaPlayer to videoItem
        ...
        # Apply mirror transformation (flip horizontally)
        self.applyMirrorTransformation()

    def applyMirrorTransformation(self):
        transform = QTransform()
        transform.scale(-1, 1)  # Flip horizontally
        self.videoItem.setTransform(transform)
